...
transport error. Peer SPKI comes from `SPKIDigest` over the leaf certificate DER, and the same
walk fills `TLSIdentity.notBefore` / `notAfter` from UTCTime or GeneralizedTime. Minimum TLS
1.2, optionally 1.3.
