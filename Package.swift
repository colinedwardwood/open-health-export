...
let linuxCore: [Target] = [
    ...
    .target(name: "SinkMQTT", dependencies: ["MQTTCodec", "EnginePorts", "NetEgress", "WireFormat", "CoreDomain", "DestinationTrust", "RequestTemplate"]),
    .target(
        name: "TestSupport",
        dependencies: [
            "CoreDomain",
...
var products: [Product] = [
    ...
    .library(name: "OTLPExport", targets: ["OTLPExport"]),
